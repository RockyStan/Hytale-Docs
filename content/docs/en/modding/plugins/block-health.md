---
id: block-health
title: Block Health System
sidebar_label: Block Health
sidebar_position: 7
description: Complete documentation of the Hytale block health system for block damage, regeneration, fragility, and breaking progression
---
...
| Class | Description |
|-------|-------------|
| `BlockHealthModule` | The core module/plugin that manages the entire system |
| `BlockHealth` | Represents the health state of a single block |
| `BlockHealthChunk` | Stores block health data for all blocks within a chunk |
| `FragileBlock` | Tracks blocks that are in a temporary fragile state |
